...
export const gad7Config: TestConfig = {
  ...
  slug: "اختبار-القلق",
  name: "اختبار القلق",
  conditionName: "القلق المزمن وأعراضه",
  ...
  category: "anxiety",
  icon: "🌊",
  conditionDescription: "اضطراب القلق العام هو قلق مفرط ومستمر يصعب السيطرة عليه، يمتد لأشهر حتى في غياب تهديد حقيقي. يختلف عن القلق الطبيعي في أنه يؤثر على التركيز والنوم والعلاقات والأداء اليومي. أبرز أعراضه: الشعور الدائم بالتوتر والانفعال، صعوبة الاسترخاء، القلق الزائد من أشياء كثيرة في آنٍ واحد، التعب الجسدي المرتبط بالقلق، والشعور بأن شيئاً سيئاً سيحدث. يُعدّ من أكثر الاضطرابات النفسية شيوعاً — يؤثر على حوالي 4% من البالغين عالمياً — ويستجيب بشكل ممتاز للعلاج المعرفي السلوكي وتقنيات إدارة القلق.",
  answerOptions: [
    { label: "أبداً", value: 0 },
